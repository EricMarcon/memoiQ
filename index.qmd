...
- \\mainmatter dans modèle, propriété has.front-matter
- Traitement des auteurs dans title.tex
- main font et math font dans le modèle
- paramétrer graphicspath (au lieu de header)
- options :
...
\\mainmatter génère une erreur au prochain chapitre à cause de babel. Polyglosssia règle le problème:
